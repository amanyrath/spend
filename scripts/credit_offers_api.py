"""
FastAPI Mock Credit Offers API
Simulates a credit card pre-qualification system with balance transfer focus
"""
...
app = FastAPI(title="Credit Offers Pre-Qualification API", version="1.0.0")
...
@app.post("/credit-offers/prequalifications", response_model=PrequalificationResponse)
async def create_prequalification(customer: CustomerInfo):
    """
...
async def root():
    return {
        "message": "Credit Offers Pre-Qualification API",
        "version": "1.0.0",
        "docs": "/docs"
    }
